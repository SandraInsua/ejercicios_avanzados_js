...
const updatedCharacters2 = removeItem(mainCharacters, "Leia");
console.log(updatedCharacters2); 
const updatedCharacters3 = removeItem(mainCharacters, "Luke");
console.log(updatedCharacters3); 
const updatedCharacters4 = removeItem(mainCharacters, "Chewbacca");
console.log(updatedCharacters4);
